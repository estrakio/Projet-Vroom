...
<div class="row" id="content">
  ...
  <div class="col-4">
    <br>
    <br>
    <h1><b class="">Site de gestion de l'entreprise de leasing Vroooom</b></h1>
    <h3>Ce projet contient un site web ainsi qu'une application mobile</h3>
    <hr>
    <hr>
    <div class="row">
      <div class="col-6">
